 ...
 */
System.register(['angular2/core', "./authors.service", "./auto-grow.directive"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, authors_service_1, auto_grow_directive_1;
        ...
        execute: function() {
            AuthorsComponent = (function () {
                function AuthorsComponent(authorsService) {
                    this.authorsTitle = "Authors";
                    this.authorsName = authorsService.getAuthorNames();
                }
                AuthorsComponent = __decorate([
                    core_1.Component({ selector: 'authors',
